...
### 7.3 色だけに意味を持たせない（アクセシビリティ）

- 色は補助とし、**線種・形状・ラベルだけで区別が成立する状態**を保つ（色覚特性・モノクロ印刷・ダーク/ライト両モードで意味が消えないため）
- 図が伝えきれない内容は図に押し込めず、本文・テーブルで文章補完する（§3.5）
...
- [ ] 色を外しても（モノクロでも）線種・形状・ラベルで区別が成立するか
