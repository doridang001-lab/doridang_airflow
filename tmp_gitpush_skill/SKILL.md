---
name: gitpush
description: Publish repo changes with the Doridang branch-and-PR workflow instead of pushing directly to main. Use when Codex needs to inspect git changes, create or reuse a feature branch, run the workspace gitpush helper, open a PR, or merge the PR after user approval. Trigger on requests such as $gitpush, gitpush, or /gitpush-style publishing.
---
